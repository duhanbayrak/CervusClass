...
export function WeeklyScheduler({ events, studySessions = [], role, onDelete, onEventClick, onSlotClick, currentUserId, selectedSessionIds = [] }: Readonly<WeeklySchedulerProps>) {
                                    ...
                                    {daySessions.map(session => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                type="button"
                                                className={cn(
                                                    "absolute rounded px-2 py-1 text-xs border shadow-sm cursor-pointer transition-all overflow-hidden z-20 text-left",
                                                    "flex flex-col justify-start",
                                                    classes.container,
