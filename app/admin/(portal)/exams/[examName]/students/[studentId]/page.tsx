...
async function getStudentExamDetails(examName: string, studentId: string) {
    ...
    // Get student's exam result (Admin context via RLS fix)
    ...
    return (
        <div className="container py-8 max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                {/* Link back to Class Detail instead of Exam List for better navigation flow */}
                <Link href={`/admin/exams/${encodeURIComponent(examName)}/${data.student.classId}`}>
                ...
                <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <span className="text-sm font-medium">Öğrenci Detayı (Admin)</span>
                </div>
            </div>
